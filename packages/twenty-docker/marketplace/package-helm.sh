...
echo ""
echo "--- AZURE MARKETPLACE (Azure Container Registry) ---"
echo "1. Authenticate Helm with Azure ACR:"
echo "   az acr login --name <REGISTRY_NAME>"
echo ""
echo "2. Push Helm OCI Artifact:"
echo "   helm push \"$BUILD_DIR/$CHART_NAME\" oci://<REGISTRY_NAME>.azurecr.io/<REPOSITORY_NAME>"
echo "========================================="
